...
for(ii in 1:length(year_range)) {
  ...
  depths_to_save <- unique(temp$depth)[c(1,5,7,9,10:14)]# 55.76429 109.72930 155.85069 222.47520 266.04031 318.12741 380.21301 453.93771 541.08893
...
saveRDS(all_dat, "indices/temp_indices_norway.rds")
